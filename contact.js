        ...
        function showLoginModal() {
            ...
            document.getElementById('loginForm').addEventListener('submit', function(e) {
                ...
                // Ensure per-user carts exist and sync them to shared storage
                if (currentUser && currentUser.email) {
        ...
        document.addEventListener('DOMContentLoaded', () => {
            ...
            // Add some demo items to cart for showcase (only for logged-in users)
        ...
        // React to auth changes made in global script
